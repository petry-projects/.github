...
| **Require last push approval** | **Yes** — ensures different people review substantive code changes; Dependabot rebase workflow updates branches and directly merges via its bypass actor, bypassing the re-approval requirement |
