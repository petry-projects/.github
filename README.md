...
| [`gitignore-standard`](standards/gitignore-standard.md) | `.gitignore` policy and org-managed secret baseline | Two-Layer Model, L1 secrets baseline (verbatim, required), managed-block markers, negation discipline, compliance check |
